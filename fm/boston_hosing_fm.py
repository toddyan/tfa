...
W = tf.get_variable("sqr_weight", shape=[13,6], dtype=tf.float32, initializer=tf.truncated_normal_initializer(stddev=0.1))
b = tf.get_variable("bias", shape=[], dtype=tf.float32, initializer=tf.constant_initializer())
emb = tf.matmul(feature, W) # [None, 4]
...
# fm: learning_rate 0.0001, batch_size 32, emb 6, test_loss 84.35
# fm: learning_rate 0.0001, batch_size 32, emb 5, test_loss 84.32
# fm: learning_rate 0.0001, batch_size 32, emb 4, test_loss 84.27
# fm: learning_rate 0.0001, batch_size 32, emb 3, test_loss 84.26
# fm: learning_rate 0.0001, batch_size 32, emb 2, test_loss 84.27