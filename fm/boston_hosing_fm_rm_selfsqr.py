...
# fm: learning_rate 0.0001, batch_size 32, emb 5, test_loss
# fm: learning_rate 0.0001, batch_size 32, emb 4, test_loss
# fm: learning_rate 0.0001, batch_size 32, emb 3, test_loss
# fm: learning_rate 0.0001, batch_size 32, emb 2, test_loss